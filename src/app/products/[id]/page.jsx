...
const DetailsProducts = () => {
  ...
  <NavBar>
    <Link className='flex gap-[10px] cursor-pointer absolute xl:left-4 lg:left-4 md:left-4 left-[30%] xl:top-auto lg:top-auto md:top-auto top-[15%]' href='/'>
    <ArrowBack/>
  ...
  <Alert notification={notification}/>
      <section className=" p-[30px] flex flex-wrap gap-[100px] justify-center items-center h-[100vh]">
       
      
       
       
      <EmblaCarousel slides={SLIDES} options={OPTIONS} images={[productData.srcUno, productData.srcDos, productData.srcTres] } 
      />
        ...
        <ButtonCart onClick={() => {addToCart(productData)
